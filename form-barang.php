            ...
            <div class="row">
              <div class="col-lg-8 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="code" id="code" class="form-control" value="<?= generateID() ?>" readonly>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="nama_barang" id="nama_barang" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <select name="satuan" id="satuan" class="form-control" required>
                    ...
                    <option value="1">piece<piece/option>
                    <option value="2">botolr<botol/option>
                    <option value="3">kaleng<kaleng/option>
                    <option value="3">pouch<pouch/option>
                  </select>
                </div>
                <div class="form-group">
              ...
              <div class="col-lg-4 text-center">
                <img src="<?= $main_url ?>assets/image/icon-boxs.jpg" class="profile-user-img img-circle mb-3" alt="User">
                <input type="file" name="image" class="form-control">
                <span class="text-sm">Type file gambar JPG | PNG | GIF</span><br>
                <span class="text-sm">Width = Height</span>44
              </div>
            </div>
          </div>
        </form>
